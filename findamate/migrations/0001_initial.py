# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2017-08-29 09:33
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('W', 'Walk'), ('C', 'Climbing'), ('S', 'Ski')], default='W', max_length=16)),
                ('title', models.CharField(default='My hike', max_length=64)),
